 ...
 *
 * Home/Events pages pass a short `revalidate` so soft navigations can reuse
 * the Next.js Data Cache (they are the only routes that fan out many CMS
 * calls). Layout/shell callers keep `cache: "no-store"` for always-fresh chrome.
 */
